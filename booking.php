                ...
                <div class="col">
                    ...
                    <?php echo '<form action="db_booking.php?email=' . urlencode($email). '" method="post">' ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="passengerName" type="text" class="form-control" id="idEmail" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="phoneNumber" type="text" class="form-control" id="idPassword" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="streetNumber" type="text" class="form-control" id="idPassword" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="idPassword" class="col-sm-4 col-form-label">Street name:</label>
                                    <div class="col-sm-8">
                                        <input name="streetName" type="text" class="form-control" id="idPassword" placeholder="">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="suburb" type="text" class="form-control" id="idPassword" placeholder="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="pickupDate" type="text" class="form-control" id="idPassword" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="pickupTime" type="text" class="form-control" id="idPassword" placeholder="">
                            </div>
                        </div>
